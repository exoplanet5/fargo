...
InitVariables()
{
  ...
  var("INNERBOUNDARY", OPENINNERBOUNDARY, STRING, NO, "OPEN");
...
//  var("RSIGMA", &RSIGMA, REAL, YES, "100.0");		// remove width
//  var("ETA", &ETA, REAL, YES, "0.01");			// remove mount
  var("TORS", &TORS, REAL, NO, "0.0");			// torque 
  var("INCLI", &INCLI, REAL, NO, "0.0");		// inclination
  var("BETA", &BETA, REAL, NO, "1.0");			// remove timescale power
  var("TNUM", &TNUM, REAL, NO, "1.0");                  // number of period
  var("FACT", &FACT, REAL, NO, "1.0");		// alphaviscous down factor
  var("MASSPLANET", &MASSPLANET, REAL, NO, "3.0e-6"); //Final mass of planet
  var("HRATIO", &HRATIO, REAL, NO, "0.0"); //HillRadius ratio of Binaty H2O
  var("MASSRATIO", &MASSRATIO, REAL, NO, "1.0"); //Mass ratio of Binaty H2O
}
